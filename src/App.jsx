  ...
  return (
    <div>
      ...
      <Sec title={<span>Customer Authorization Form {a.customerAuthSig ? <span style={{color:"#22c55e",fontSize:11}}>✓ Signed</span> : <span style={{color:"#f59e0b",fontSize:11}}>⚠ Required</span>}</span>}>
        {!a.customerAuthSig && <Rec type="warn">Customer must sign Authorization Form before assessment begins.</Rec>}
...
<div style="font-size:10px;color:#666;margin-bottom:8px">ComEd Energy Efficiency Program &nbsp;|&nbsp; Nicor Gas Energy Efficiency Program &nbsp;|&nbsp; Peoples Gas Energy Efficiency Program &nbsp;|&nbsp; North Shore Gas Energy Efficiency Program</div>
</div>
<h2 style="font-size:18px;margin:0 0 2px;font-weight:bold">Home Energy Savings Program</h2>
<h3 style="font-size:14px;color:#2196F3;margin:0 0 14px;font-weight:600">Customer Authorization Form</h3>
<p style="font-size:11px;line-height:1.6;margin:0 0 12px">Commonwealth Edison Company (&ldquo;ComEd&rdquo;), Nicor Gas, North Shore Gas, and Peoples Gas (collectively, the &ldquo;Utilities&rdquo;) are jointly funding the Home Energy Savings offering (&ldquo;Offering&rdquo;) for eligible residential customers to facilitate the identification and implementation of energy efficiency improvements available at their homes. As a customer of at least one of the Utilities, you may be eligible to receive comprehensive home improvements at no charge that will help you save energy and money on your monthly energy bills. This Customer Authorization Form sets forth the terms and conditions applicable to customers participating in the Offering.</p>
<p style="font-size:11px;line-height:1.6;margin:0 0 6px">By signing below, I certify that:</p>
<p style="font-size:11px;line-height:1.6;margin:0 0 3px;padding-left:16px">1. I am an account holder with one of the Utilities at the property address listed below and that I have the authority to accept the Offering Terms and Conditions outlined in this Customer Authorization form;</p>
<p style="font-size:11px;line-height:1.6;margin:0 0 3px;padding-left:16px">2. I have read, understand, and agree to comply with the Offering Terms and Conditions; and</p>
<p style="font-size:11px;line-height:1.6;margin:0 0 14px;padding-left:16px">3. If signing by electronic signature, I agree that my electronic signature is the legal equivalent of my handwritten signature.</p>
...
<tr><td style="padding:8px 10px;font-size:11px;border:1px solid #ccc;width:50%;vertical-align:top">Customer Signature</td><td style="padding:4px 10px;border:1px solid #ccc">${sigImg}</td></tr>
...
<h3 style="font-size:13px;color:#2196F3;margin:0 0 10px;font-weight:600">Offering Terms and Conditions</h3>
<p style="font-size:9px;line-height:1.5;margin:0 0 6px"><b>Offering Year:</b> The Offering Year is from January 1st through December 31st. Eligible projects are accepted on a first-come, first-served basis until the conclusion of the Offering Year, or until Offering funds are exhausted, whichever comes first.</p>
<p style="font-size:9px;line-height:1.5;margin:0 0 6px"><b>Implementing Contractor:</b> The Utilities have contracted and authorized Resource Innovations, LLC (&ldquo;Implementing Contractor&rdquo;) to administer the Offering including such activities, but not limited to; review, processing, and approval of customer projects; pre and post inspections of customer premises; to facilitate project information requests from customers and Installation Contractors; and measurement and verification activities.</p>
<p style="font-size:9px;line-height:1.5;margin:0 0 6px"><b>Installation Contractor:</b> As a convenience to customers, the Offering has identified contractors, service providers, and other organizations who are approved to assist customers participating in the Offering (&ldquo;Installation Contractors&rdquo;). For this program, Customer will be required to engage an Installation Contractor approved by the Offering to qualify for incentives through the Offering. Customer acknowledges that the Utilities, Implementing Contractor, and the Installation Contractor are independent contractors with respect to the Offering, and that Installation Contractors are not authorized to make representations or incur obligations on behalf of the Utilities or Implementing Contractor. Participation as an Installation Contractor does not constitute an endorsement by the Utilities or Implementing Contractor, nor does it certify or guarantee the quality of work performed.</p>
<p style="font-size:9px;line-height:1.5;margin:0 0 6px"><b>Eligibility:</b> To be eligible for the Offering, Customer must: be an account holder with one of the Utilities; live in a single-family home (up to two units); and have an annual household income of less than 80% of Area Median Income.</p>
<p style="font-size:9px;line-height:1.5;margin:0 0 6px"><b>Tenants:</b> If a tenant, Customer is responsible for obtaining the property owner&rsquo;s permission to participate in the Offering by submitting a completed Property Owner Authorization and Agreement Form signed by the property owner. Customer&rsquo;s signature on this Customer Authorization Form indicates that Customer has obtained such permission.</p>
<p style="font-size:9px;line-height:1.5;margin:0 0 6px"><b>Offering Participation Steps:</b> An Installation Contractor will meet with Customer to conduct an assessment of Customer&rsquo;s home to identify opportunities that Customer may qualify for through the Offering. The Installation Contractor will obtain Customer permission to proceed with the installation of qualified measures.</p>
<p style="font-size:9px;line-height:1.5;margin:0 0 6px"><b>Project Payment:</b> The Offering provides incentives for the installation of eligible measures. Payment of the incentive amount is issued directly to Customer&rsquo;s Installation Contractor. Eligible equipment receiving incentives under the Offering are not eligible for purchase and installation incentives or credits under any other Utility Offerings.</p>
<p style="font-size:9px;line-height:1.5;margin:0 0 6px"><b>Right to Inspect/Access:</b> The Utilities reserve the right to conduct post-installation inspections of all improvements to verify compliance with Offering requirements and/or to perform participant interviews. For a period of one year after the date of installation, and upon reasonable notice by the Utilities, Customer agrees to allow access to project documents and the installed improvements. Customer may be contacted by an evaluator to complete a customer survey.</p>
<div style="page-break-before:always"></div>
<p style="font-size:9px;line-height:1.5;margin:0 0 6px"><b>Customer Information:</b> Customer authorizes and acknowledges that the Utilities may duplicate, disseminate, release and disclose Customer&rsquo;s information relating to a Customer application (including the entirety of its contents), and any other information related to the Customer&rsquo;s participation in the Offering, including but not limited to customer contact information, account information and billing data, energy usage, and tax identification numbers to Implementing Contractor and Installation Contractors, as applicable, and any other third party utilized by the Utilities for the purpose of providing Offering services, reviewing and processing the Customer Application, to confirm eligibility for participation in the Offering, to verify equipment installation or service implementation, operation and results, to issue payment on behalf of the Offering, to monitor compliance with Offering requirements and terms; or as required to comply with state and/or federal law, fraud prevention, regulation, and other legal action.</p>
<p style="font-size:9px;line-height:1.5;margin:0 0 6px"><b>PJM Capacity Credits:</b> Customer will be entitled to the energy cost savings realized by Customer that result from the installation of Energy Conservation Measures (&ldquo;ECMs&rdquo;) at Customer&rsquo;s home. In consideration of the services provided as part of this Offering, Customer agrees that the Utilities are entitled to 100% of the rights and benefits associated with the measures, including without limitation PJM products and all other attributes, credits or products associated therewith under any regional initiative or federal, state or local law, Offering or regulation, and Customer waives, and agrees not to seek, any right to the same.</p>
<p style="font-size:9px;line-height:1.5;margin:0 0 6px"><b>Project Installations:</b> Customer acknowledges that while the Offering may provide energy assessments and identification of energy efficiency opportunities available at the Customer&rsquo;s home, neither the Utilities nor Implementing Contractor will install or implement such equipment or measures. Installation of and implementation of any qualifying equipment or measures will be carried out by the Installation Contractor working with Customer. The Utilities and Implementing Contractor assume no responsibility for oversight of contractor services, or for any claims the Customer might have against the manufacturer, the retailer or the Installation Contractor regarding services or measures implemented under the Offering.</p>
<p style="font-size:9px;line-height:1.5;margin:0 0 6px"><b>Toxic Materials:</b> Neither the Utilities nor its Implementing Contractor shall have any responsibility for the discovery, presence, handling, removal, disposal of, or exposure to hazardous materials of any kind in connection with customer&rsquo;s facility, including without limitation, asbestos, asbestos products, PCBs or any other toxic substances.</p>
<p style="font-size:9px;line-height:1.5;margin:0 0 6px"><b>Disclaimer of Warranties:</b> Customer shall independently evaluate any information provided by the Utilities, Implementing Contractor, or an Installation Contractor related to estimates of energy savings or costs for the selection of equipment or measures to be installed or implemented. THE UTILITIES AND IMPLEMENTING CONTRACTOR DO NOT MAKE ANY WARRANTIES OR REPRESENTATIONS OF ANY KIND WITH RESPECT TO THE DESIGN, MANUFACTURE, CONSTRUCTION, SAFETY, OPERATION, PERFORMANCE, INSTALLATION, EFFECTIVENESS OR ANY POTENTIAL ENERGY OR COST SAVINGS OF EQUIPMENT INSTALLED, MEASURES IMPLEMENTED, AND/OR SERVICES RENDERED BY ANY PERSON OR ENTITY IN CONNECTION WITH THE OFFERING. THE UTILITIES AND IMPLEMENTING CONTRACTOR DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED, TO THE MAXIMUM EXTENT PERMITTED UNDER LAW, WHETHER STATUTORY OR OTHERWISE, INCLUDING WITHOUT LIMITATION ANY WARRANTIES OF MERCHANTABILITY OR FITNESS FOR A PARTICULAR PURPOSE, USE, ENERGY SAVINGS, AND NON-INFRINGEMENT.</p>
<p style="font-size:9px;line-height:1.5;margin:0 0 6px"><b>Fraud:</b> Any person who knowingly files an application containing any materially false information or who purposely or misleadingly conceals information subjects such person to criminal and civil penalties. Any and all funds determined to have been acquired on the basis of inaccurate or fraudulent information must be returned to the Utilities. Any customer found to be engaged in fraudulent activity or misrepresentation of any kind will be removed from the Offering.</p>
<p style="font-size:9px;line-height:1.5;margin:0 0 6px"><b>Indemnification:</b> Customer shall defend, indemnify and hold harmless the Utilities, Implementing Contractor and their respective affiliates, officers, directors, shareholders, agents, employees, contractors, and representatives (the &ldquo;Indemnified Parties&rdquo;) from and against any and all liability, claims, losses, damages, demands, judgments, causes of action, suits, costs (including reasonable attorney&rsquo;s fees and expenses) and liability of every kind and character whatsoever (&ldquo;Claims&rdquo;) arising out of or related in any way to, directly or indirectly, Customer&rsquo;s participation in the Offering or its failure to comply with any of its obligations hereunder; provided however, that Customer shall not be required to indemnify and hold harmless any Indemnified Party against Claims adjudicated to have been caused by an Indemnified Party&rsquo;s negligence or willful misconduct.</p>
<p style="font-size:9px;line-height:1.5;margin:0 0 6px"><b>Limitation of Liability:</b> The Utilities and Implementing Contractor&rsquo;s total liability, regardless of the number of claims, is limited to the amount of the incentive payment approved in accordance with Offering requirements. To the fullest extent allowed by law, the Utilities and Implementing Contractor shall not be liable hereunder for any type of damages, whether indirect, incidental, consequential, exemplary, reliance, punitive or special damages, including, without limitation, loss of use or loss of profits, regardless of the form of action, whether in contract, indemnity, warranty, strict liability or tort, including negligence of any kind.</p>
<p style="font-size:9px;line-height:1.5;margin:0 0 6px"><b>Governing Law:</b> Participation in this Offering will be exclusively governed by and interpreted in accordance with the laws of the State of Illinois. Any litigation brought against the Utilities by or on behalf of Customer shall be prosecuted only in the state or federal courts located in Cook County, Illinois.</p>
<p style="font-size:9px;line-height:1.5;margin:14px 0 0;font-style:italic;text-align:center">This program is funded by ComEd, Nicor Gas, Peoples Gas, and North Shore Gas customers in compliance with state law. Terms and conditions apply.</p>
</div>`);
          }}>🖨️ Print Signed Authorization Form</button>
        </div>}
        {a.customerAuthSig && <Rec type="rec">Customer Authorization signed {a.authDate ? new Date(a.authDate).toLocaleDateString("en-US") : ""} ✓</Rec>}
      </Sec>
